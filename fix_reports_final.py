...
code = code.replace(
    ...
    'type ReportType = "receber" | "pagar" | "vencidas_pagar" | "iva_credito" | "despesas" | "consumo_lojas" | "fornecedores";'
)

# Update options and order
...
# Remove the whole total_lojas branch
start_marker = '} else if (reportType === "total_lojas") {'
end_marker = '} else if (reportType === "consumo_lojas") {'
