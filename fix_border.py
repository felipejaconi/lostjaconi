...
content = content.replace(
    ...
    "className={`w-10 h-10 rounded-lg border flex items-center justify-center p-px relative group cursor-pointer transition-transform hover:scale-110 z-10 hover:z-20 ${colorClass}`}"
)
