...
old_block = """                              <div className="w-full flex flex-row gap-1.5 mt-auto pt-3">
                                 <button 
                                    onClick={() => { setSelectedStore(store); setIsStoreModalOpen(true); }}
                                    className="flex-1 min-w-0 py-1.5 px-1 sm:px-2 bg-amber-500/10 hover:bg-amber-500/20 text-amber-500 rounded-md text-[8px] sm:text-[9px] font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-1 border border-amber-500/20"
                                    title="Nova Despesa"
                                 >
                                 ...
                                 <button 
                                    ...
                                    className="flex-1 min-w-0 py-1.5 px-1 sm:px-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white rounded-md text-[8px] sm:text-[9px] font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-1 border border-zinc-700/50"
                                    title="Faturas"
                                 >
...
new_block = """                              <div className="w-full flex flex-wrap gap-1.5 mt-auto pt-3">
                                 <button 
                                    onClick={() => { setSelectedStore(store); setIsStoreModalOpen(true); }}
